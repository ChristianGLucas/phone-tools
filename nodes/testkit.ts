// Shared test context for phone-tools node unit tests. Not a node and not a test
// file (no describe/it), so it is neither registered as a node nor collected by
// jest — it just provides a minimal AxiomContext the pure nodes never read.
import {
  AxiomContext,
  AxiomLogger,
  AxiomSecrets,
