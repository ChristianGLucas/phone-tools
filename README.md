...
https://dev.axiomide.com/marketplace/christiangeorgelucas/phone-tools@0.1.1
...
```bash
axiom invoke christiangeorgelucas/phone-tools/Parse --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/phone-tools/0.1.1/Parse \
...
> `axiom inspect node christiangeorgelucas/phone-tools/Parse`.
